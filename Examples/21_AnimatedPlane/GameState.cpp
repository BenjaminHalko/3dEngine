...
void GameState::Update(float deltaTime)
{
    ...
    if (!mFreeCam)
    {
        ...
        case 14:
        {
            ...
            Math::Vector3 giantHead = giantPos + Math::Vector3{0.0f, 100.0f, 0.0f};
...
void GameState::OnShotEnter(int shot, const Engine::Graphics::Transform& smoothT)
{
    ...
    case 14:
        if (!mGiantLoaded)
        {
            ...
            mDancerLeft.transform.position = giantPos + Math::Vector3{0.0f, 30.0f, -40.0f};
            ...
            mDancerRight.transform.position = giantPos + Math::Vector3{0.0f, 30.0f, 40.0f};
