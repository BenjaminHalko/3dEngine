...
void UIButtonComponent::Initialize()
{
    ...
    ASSERT(uiRenderService != nullptr, "UIButtonComponent: Needs a UI render service!");
...
void UIButtonComponent::Deserialize(const rapidjson::Value& value)
{
    ...
    for (uint32_t i = 0; i < buttonStateCount; ++i)
    {
        ...
        case ButtonState::Default:
            buttonStateStr = "Default";
            break;
        case ButtonState::Hover:
            buttonStateStr = "Hover";
            break;
        case ButtonState::Click:
            buttonStateStr = "Click";
            break;
        case ButtonState::Disabled:
            buttonStateStr = "Disabled";
            break;
        default:
            break;
        }
