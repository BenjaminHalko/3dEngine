...
void ShapeState::Initialize() {
    ...
    hr = D3DCompileFromFile(shaderFilePath.c_str(), nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
                            "VS", "vs_5_0", shaderFlags, 0, &shaderBlob, &errorBlob);
    ...
    hr = device->CreateInputLayout(vertexLayout.data(), static_cast<UINT>(vertexLayout.size()),
    ...
    hr = D3DCompileFromFile(shaderFilePath.c_str(), nullptr, D3D_COMPILE_STANDARD_FILE_INCLUDE,
                            "PS", "ps_5_0", shaderFlags, 0, &shaderBlob, &errorBlob);
...
void ShapeState::Update(float deltaTime) {
    ...
    if (Input::InputSystem::Get()->IsKeyPressed(Input::KeyCode::LEFT)) {
        Engine::MainApp().ChangeState("House");
    }
