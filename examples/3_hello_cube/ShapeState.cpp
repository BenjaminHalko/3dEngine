...
void CubeState::CreateShape() { mMesh = MeshBuilder::CreateCubePC(1.0f); }
...
void PyramidState::CreateShape() { mMesh = MeshBuilder::CreatePyramidPC(1.0f); }
...
void RectangleState::CreateShape() { mMesh = MeshBuilder::CreateRectanglePC(1.0f, 1.0f, 2.0f); }